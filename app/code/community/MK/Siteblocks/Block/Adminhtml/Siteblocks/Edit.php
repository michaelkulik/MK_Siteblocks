...
class MK_Siteblocks_Block_Adminhtml_Siteblocks_Edit extends Mage_Adminhtml_Block_Widget_Form_Container
{
    public function __construct()
    {
        ...
        $this->_updateButton('reset', 'label', Mage::helper('siteblocks')->__('Reset'));
        $this->_updateButton('back', 'label', Mage::helper('siteblocks')->__('Back'));
    ...
    {
        if (Mage::registry('siteblocks_block')->getSiteblockId()) {
