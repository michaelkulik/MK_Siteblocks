...
class MK_Siteblocks_Block_Adminhtml_Siteblocks_Edit_Renderer_Myimage extends Varien_Data_Form_Element_Abstract
{
    /**
     * Constructor
     *
    ...
    protected function _getDeleteCheckbox()
    {
        $html = '';
        if ($this->getValue()) {
            $label = Mage::helper('siteblocks')->__('Put this checkbox to delete existing image');
